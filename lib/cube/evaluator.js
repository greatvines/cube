...
exports.register = function(db, endpoints) {
  ...
  endpoints.http.push(
    ...
    endpoint("OPTIONS", "/1.0/event", eventGet),
    endpoint("OPTIONS", "/1.0/event/get", eventGet),
    endpoint("OPTIONS", "/1.0/metric", metricGet),
    endpoint("OPTIONS", "/1.0/metric/get", metricGet),
    endpoint("OPTIONS", "/1.0/types", typesGet),
    endpoint("OPTIONS", "/1.0/types/get", typesGet)
  );
